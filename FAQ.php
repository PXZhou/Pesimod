...
$title = "FAQ";
    ...
    <li id='q3'> <p><a href='#a3'>Je ne peux pas ajouter de nouveau capteur dans une pièce, pourquoi ?</a></p>
    <li id='q4'> <a href='#a4'>Je ne peux pas ajouter plusieurs maisons, pourquoi ?/a></li>
    <li id='q5'> <a href='#a5'>Je ne trouve pas trouver la réponse à ma question, comment régler mon problème ?</a></li>

    <div id='a1'>
    <h2>Que puis-je contrôler avec Pesimod ?</h2>
    <p>Vous pouvez contrôler les différents capteurs de votre maison, via votre interface de Pesimod.</p>
    </div>
    <div id='a2'>
